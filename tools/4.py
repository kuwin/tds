...
\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mBOX SUPPORT: \033[1;37mhttps://zalo.me/g/ykntan866
\033[1;31m────────────────────────────────────────────────────────────
"""
 for X in banner:
  sys.stdout.write(X)
...
banner()
token_tds = input(f'{ndp_tool}{luc}Nhập Token TDS{trang}:{vang} ')
...
print(f'{ndp_tool}{luc}Xu Die{trang}: {vang}{xudie}')

print(f'{ndp_tool}{luc}Nhập Số {do}[{vang}1{do}] {luc}Chạy Nhiệm Vụ Tym')
print(f'{ndp_tool}{luc}Nhập Số {do}[{vang}2{do}] {luc}Chạy Nhiệm Vụ Follow')
print(f'{ndp_tool}{luc}Nhập Số {do}[{vang}3{do}] {luc}Chạy Nhiệm Vụ Tym Comment')
print(f'{ndp_tool}{luc}Nhập Số {do}[{vang}4{do}] {luc}Chạy Nhiệm Vụ Comment {do}[{vang}Báº¢O TRĂŒ{do}]')

chonjob = input(f'{ndp_tool}{luc}Nhập Nhiệm Vụ Chạy{trang}: {vang}')
delayjob = int(input(f'{ndp_tool}{luc}Nhập Delay{trang}: {vang}'))
os.system("cls" if os.name == "nt" else "clear")
banner()
#Load Job
def delay_ndp(o):
	while (o>1):
		o=o-1
		print(luc+' Tiếp Tục Sau'+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(do+' Tiếp Tục Sau'+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(vang+' Tiếp Tục Sau'+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(hong+' Tiếp Tục Sau'+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(xnhac+' Tiếp Tục Sau'+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
def loadjob(o):
	while (o>1):
		o=o-1
		print(luc+' Đang Làm Nhiệm Vụ '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(do+' Đang Làm Nhiệm Vụ '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(vang+' Đang Làm Nhiệm Vụ '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(hong+' Đang Làm Nhiệm Vụ '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(xnhac+' Đang Làm Nhiệm Vụ '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
