...
class API_PRO5_ByNgDucPhat:
    def banner(self):
        os.system('title TOOL REG PAGR PRO5 + UP AVT | ĐA LUỒNG  - NGUYENDUCPHAT2007')
...
\033[1;34m[\033[1;33m●\033[1;34m] \033[1;32m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m═══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m══\x1b[1;91m══\033[1;32m══\033[1;31m══\x1b[1;94m══\x1b[1;96m═══""" 
    ...
    def ndp_delay_tool(self, p):
        ...
        while(p>1):
            p=p-1
            print(f'[ 🌺 𝐗𝐮𝐨̣̂𝐭 𝐃𝐞𝐯 🌺][|][LO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌺 𝐗𝐮𝐨̣̂𝐭 𝐃𝐞𝐯 🌺][/][LOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌺 𝐗𝐮𝐨̣̂𝐭 𝐃𝐞𝐯 🌺][-][LOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌺 𝐗𝐮𝐨̣̂𝐭 𝐃𝐞𝐯 🌺][+][LOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌺 𝐗𝐮𝐨̣̂𝐭 𝐃𝐞𝐯 🌺][\][LOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌺 𝐗𝐮𝐨̣̂𝐭 𝐃𝐞𝐯 🌺][|][LOADING.][{p}]','     ',end='\r');sleep(1/6)
