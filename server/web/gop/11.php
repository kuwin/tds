...
os.system('clear')
haidang = ' \033[1;97m[\033[1;31m=>\033[1;97m] ➩'
print(haidang,' \033[1;32mTOOL SHARE ẢO MAX SPEED BẰNG COOKIE PAGE')
...
if keynhap == keyy:
    ...
    uid=input('\033[1m\033[38;5;51mNhập id bài viết lấy ở id.traodoisub.com:\033[38;5;15m ')
    ...
    ck_fb=input('\033[1m\033[38;5;51mNhập Cookie Facebook :\033[38;5;15m ')
    ...
    def Start(l):
        ...
        for tach in getTokenPage:
            ...
            if "error" in buff:
                print(f'\033[1m\033[38;5;237m[\033[38;5;54m*\033[38;5;237m]\033[0m \033[4m\033[38;5;164m\033[0m \033[1;31mShare Lỗi Rồi Kìa Xem Lại Page Đê')
            else:
                print(f'\033[1m\033[38;5;237m[\033[38;5;54m*\033[38;5;237m]\033[0m \033[4m\033[38;5;164m\033[0m \033[1m\033[38;5;51mShare Thành Công')
    ...
    for t in threades:
        t.join()
    print('\033[1;31mĐã Xong, Cảm Ơn Bạn Đã Tin Tưởng Dùng Tool')