...
def idelay(o):
    while(o>0):
        o=o-1
        print(f"[vLong][.....""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[vLong][X....""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[vLong][XX...""]""["+str(o)+"]" "     ",end='\r')
        sleep(1/6)
        print(f"[vLong][XXX..""]""["+str(o)+"]"" ",end='\r')
        sleep(1/6)
        print(f"[vLong][XXXX.""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[vLong][XXXXX""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
