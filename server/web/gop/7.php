...
def idelay(o):
    while(o>0):
        o=o-1
        print(f'[vLong][.....][{o}]','     ',end='\r');sleep(1/6)
        print(f'[vLong][X....][{o}]','     ',end='\r');sleep(1/6)
        print(f'[vLong][XX...][{o}]','     ',end='\r');sleep(1/6)
        print(f'[vLong][XXX..][{o}]','     ',end='\r');sleep(1/6)
        print(f'[vLong][XXXX.][{o}]','     ',end='\r');sleep(1/6)
        print(f'[vLong][XXXXX][{o}]','     ',end='\r');sleep(1/6)
