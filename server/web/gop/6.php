...
░░░╚═╝░░░╚══════╝░╚════╝░╚═╝░░╚══╝░╚═════╝░"""
    ...
    def ndp_delay_tool(self, p):
        while(p>1):
            p=p-1
            print(f'[ vLong][|][LO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ vLong][/][LOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ vLong][-][LOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ vLong][+][LOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ vLong][\][LOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ vLong][|][LOADING.][{p}]','     ',end='\r');sleep(1/6)
