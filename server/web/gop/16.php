...
def check_live(cookie):
	...
	try:
		...
		return f'\033[1;36mFacebook: \033[1;32m{name} | \033[1;31mUserID: \033[1;33m{user_id}\033[1;35m'
	except:
		return False
...
if check_live(cookie) == False:
	exit(f'\033[1;34mCookie Facebook Die !!')
else:
...
while True:
	...
	for add in find:
		...
		print(f'[{dem}] | \033[1;32mKết \033[1;34mBạn | \033[1;33m{name_} - \033[1;36mID: \033[1;31m{id} \033[1;32mThành Công')
		sleep(5)